...
Overall, the likelihood expresses the idea that each patient’s observed outcome is generated by a probability specific to their features and study membership, which is then linked to the binary outcome through the logistic formulation.
...
### Distribution of the Age of Participants at Their Diagnosis Date
![alt-text](https://github.com/qthompsongit/final_project_bayesian/blob/main/graphs_and_figures/4_age_at_diagnosis_distribution.png "Age at Diagnosis Distribution")
