...
![alt-text](https://github.com/qthompsongit/final_project_bayesian/blob/main/graphs_and_figures/4_survival_time_distribution.png "Our Bayes Net Without the Target Variable")
